...
int main() {
  ...
  auto gRPCbridge = std::make_shared<Calculator::shared_calculator_bridge>(leaderCalculator);
  ...
  std::thread updateLeaderThread([&leaderCalculator]() { leaderCalculator->Run(); });
